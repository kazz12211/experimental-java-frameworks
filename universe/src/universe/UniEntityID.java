 ...
 *
 */
public abstract class UniEntityID {
	UniEntity _entity;
	int _hashCode;

	protected UniEntityID(UniEntity entity) {
		_entity = entity;
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof UniEntityID) {
			return _hashCode == ((UniEntityID) obj)._hashCode;
		}
		return false;
	}
	...
	public static class PK extends UniEntityID {
		private Object _primaryKey;
	
		public PK(UniEntity entity, Object primaryKey) {
			super(entity);
	...
	public static class KeyValue extends UniEntityID {
		private String _key;
		private Object _value;
		
		public KeyValue(UniEntity entity, String key, Object value) {
			super(entity);
			_key = key;
			_value = value;
			_hashCode = _hashCode();
